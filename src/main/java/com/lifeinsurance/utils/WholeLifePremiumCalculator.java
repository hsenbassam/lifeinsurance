...
import com.lifeinsurance.model.WholeLifeRates;

public class WholeLifePremiumCalculator {

	public static double getBasicAmount(Quote quote) {

		long age = Converter.birthdayToAge(quote.getBirthday());
		double basicRate = WholeLifeRates.getBasicRate(age);
	...
	public static double getPlusAmount(Quote quote) {
		...
		long age = Converter.birthdayToAge(quote.getBirthday());
		double plusRate = WholeLifeRates.getPlusRate(age);
	...
	public static double getUltraAmount(Quote quote) {
		...
		long age = Converter.birthdayToAge(quote.getBirthday());
		double ultraRate = WholeLifeRates.getUltraRate(age);
